...
Broker.create(identifier: 'broker1', email: 'pascal.carrie@gmail.com', password: 'milu2000') unless
  Broker.find_by_identifier('broker1')
Supplier.create(identifier: 'supplier1', entreprise_name: "customer entreprise",
                email: 'pascal.carrie@semillasl.com', password: 'milu2000',
...
Customer.create(identifier: 'customer1', email: 'pascal.carrie@semillasl.com',
                password: 'milu2000', approved: true, tin: "B000000001",
