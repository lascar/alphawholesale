...
RSpec.describe AspectsController, type: :controller do
  ...
  describe "GET #edit" do
    ...
    # TEST when a aspect is asked for edit
    # TEST then the 'welcome' page is returned
    # TEST and a message of unauthenticated is send
    describe "as guest user" do
      before :each do
        get :edit, params: {id: aspect1.to_param}
      end
    ...
    # TEST when a aspect is asked for edit that is not owned
    # TEST then the customer's page is returned
    # TEST and a message of unauthorized is send
    ...
    # TEST as a logged customer
    # TEST when a aspect that he owns is asked for edit
    # TEST then the asked aspect is assigned
    # TEST then the aspect's edit page is rendered
