...
RSpec.describe PackagingsController, type: :controller do
  ...
  describe "GET #new" do
    ...
    # TEST when packaging is asked for new
    ...
    # TEST when packaging is asked for new
    # TEST then a new packaging is assigned
    # TEST then the packaging's new page is rendered
    describe "as a logged supplier" do
      ...
      it "assigns the packaging" do
        expect(assigns(:packaging).persisted?).to be(false)
      end
    ...
    # TEST and the packaging's new page is rendered
