...
RSpec.describe PackagingsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    # TEST when a packaging is asked for showing
    # TEST then the 'welcome' page is returned
    # TEST and a message of unauthenticated is send
    describe "as guest user" do
      before :each do
        get :show, params: {id: packaging1.to_param}
      end
    ...
    # TEST when a packaging is asked for showing
    # TEST then the packaging is assigned
    # TEST then the packaging's show page is rendered
    describe "as a logged customer asking for his page" do
      ...
      it "returns the packaging's page" do
    ...
    # TEST then the packaging is assigned
    # TEST then the packaging's show page is rendered
    describe "as a logged broker asking for a packaging's page" do
      before :each do
        sign_in(broker1)
        get :show, params: {id: packaging1.to_param}
      end
