...
RSpec.describe SizesController, type: :controller do
  ...
  describe "GET #index" do
    ...
    # TEST when the list of sizes is asked for
    ...
    # TEST when the list of sizes is asked for
    # TEST then all the sizes are assigned
    ...
    describe "as a logged customer" do
      ...
      it "assigns all sizes" do
        expect(assigns(:sizes).sort).to eq(Size.with_approved(true).sort)
      end
